...
export const playgroundExperiments = [
  ...
  },
  {
    ...
    year: "2025",
    description:
      "A floating preview pattern focused on softness, timing, and positional restraint for portfolio-style interfaces.",
  },
  {
    ...
    year: "2025",
    description:
      "An experiment in pacing long-form project pages through image rhythm, section density, and controlled reveal motion.",
  },
  {
    title: "Glass Dock Navigation",
    category: "Navigation",
    year: "2025",
    description:
      "A compact navigation object exploring blur, layering, shared button states, and fullscreen menu transitions.",
  },
  {
    title: "Type Reveal System",
    category: "Typography",
    year: "2025",
    description:
      "A study of line reveals, editorial staggering, and calm motion systems for large navigation and landing-page headings.",
  },
];
...
export const playgroundNotes = [
  ...
  },
  {
    ...
    body: "Most experiments focus on motion timing, layout rhythm, transitions, navigation patterns, and how interface systems can feel more authored.",
  },
  {
